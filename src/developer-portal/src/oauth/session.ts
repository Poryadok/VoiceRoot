const SESSION_TOKEN_KEY = 'voice_access_token';
const SESSION_PKCE_KEY = 'voice_oauth_pkce_verifier';
const SESSION_OAUTH_STATE_KEY = 'voice_oauth_state';
const SESSION_EXPIRES_AT_KEY = 'voice_token_expires_at';
