...
// TestComposeTrust_live documents trust acceptance: reports 202, 2FA gate, friends-only DM block (docs/features/reports.md).
func TestComposeTrust_live(t *testing.T) {
