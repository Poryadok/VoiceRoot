...
// phase1SmokeBackend is a minimal in-process stand-in for User, Social, Chat, and Messaging
// services behind the gateway transcoder (Phase 1 DM smoke).
type phase1SmokeBackend struct {
...
func (s *phase1SmokeBackend) ListFriends(context.Context, *socialv1.ListFriendsRequest) (*socialv1.ListFriendsResponse, error) {
	return &socialv1.ListFriendsResponse{FriendList: &socialv1.FriendList{}}, nil
}

func (s *phase1SmokeBackend) ListChats(context.Context, *chatv1.ListChatsRequest) (*chatv1.ListChatsResponse, error) {
	return &chatv1.ListChatsResponse{ChatList: &chatv1.ChatList{}}, nil
}

func (s *phase1SmokeBackend) GetMessages(context.Context, *messagingv1.GetMessagesRequest) (*messagingv1.GetMessagesResponse, error) {
	return &messagingv1.GetMessagesResponse{MessageList: &messagingv1.MessageList{}}, nil
}

func (s *phase1SmokeBackend) SendMessage(_ context.Context, req *messagingv1.SendMessageRequest) (*messagingv1.SendMessageResponse, error) {
	n := s.sendCalls.Add(1)
...
func startBufconnPhase1Stack(t *testing.T, backend *phase1SmokeBackend) (grpc.ClientConnInterface, func()) {
	t.Helper()
...
// to all Phase-1 REST namespaces (users, friends, chats, messages), and MessagesSend rate limit
...
func TestGatewayPhase1REST_smokeJWT_multiNamespaceAndSendRateLimit(t *testing.T) {
	...
	backend := &phase1SmokeBackend{}
	conn, cleanup := startBufconnPhase1Stack(t, backend)
	t.Cleanup(cleanup)
