...
// TestComposeBotsUninstallCleanup_live verifies uninstall removes bot roles and pins but keeps messages.
func TestComposeBotsUninstallCleanup_live(t *testing.T) {
