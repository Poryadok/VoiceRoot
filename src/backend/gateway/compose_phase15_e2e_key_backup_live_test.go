...
// TestComposePhase15E2EKeyBackup_live documents PUT/GET /api/v1/auth/e2e-key-backup via gateway.
func TestComposePhase15E2EKeyBackup_live(t *testing.T) {
...
// TestComposePhase15E2EKeyBackup_OversizedRejected_live documents oversized blob is rejected.
func TestComposePhase15E2EKeyBackup_OversizedRejected_live(t *testing.T) {
	if !liveComposeEnabled() {
		t.Skip("set VOICE_RUN_LIVE_COMPOSE=true to run against local compose")
	}
	clearLiveComposeAuthRateLimit(t)
