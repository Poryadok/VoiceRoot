...
// TestComposePrivacyActions_live documents action privacy enforcement via Gateway (docs/features/privacy.md).
func TestComposePrivacyActions_live(t *testing.T) {
