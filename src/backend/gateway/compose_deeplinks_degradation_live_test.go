...
// TestComposeDeepLinksResolveWhenSearchDown_live ensures link resolve works without Search.
func TestComposeDeepLinksResolveWhenSearchDown_live(t *testing.T) {
