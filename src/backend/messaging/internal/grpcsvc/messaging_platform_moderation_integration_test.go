...
// TestPlatformModeration_ShadowBannedSenderMessageHiddenFromPeer documents Phase 14 shadow ban:
...
func TestPlatformModeration_ShadowBannedSenderMessageHiddenFromPeer(t *testing.T) {
	...
	applySQLFile(t, ctx, pool, "src/backend/migrations/messaging_db/000006_ghost_only.up.sql")
