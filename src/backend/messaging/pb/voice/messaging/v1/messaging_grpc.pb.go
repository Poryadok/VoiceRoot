...
func (c *messagingServiceClient) UploadPreKeyBundle(ctx context.Context, in *UploadPreKeyBundleRequest, opts ...grpc.CallOption) (*UploadPreKeyBundleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UploadPreKeyBundleResponse)
	err := c.cc.Invoke(ctx, MessagingService_UploadPreKeyBundle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) GetPreKeyBundle(ctx context.Context, in *GetPreKeyBundleRequest, opts ...grpc.CallOption) (*GetPreKeyBundleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPreKeyBundleResponse)
	err := c.cc.Invoke(ctx, MessagingService_GetPreKeyBundle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMessagingServiceServer) GetBulkReadState(context.Context, *GetBulkReadStateRequest) (*GetBulkReadStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBulkReadState not implemented")
}
func (UnimplementedMessagingServiceServer) GetChatListMetadata(context.Context, *GetChatListMetadataRequest) (*GetChatListMetadataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetChatListMetadata not implemented")
}
func (UnimplementedMessagingServiceServer) ListSharedMedia(context.Context, *ListSharedMediaRequest) (*ListSharedMediaResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSharedMedia not implemented")
}
func (UnimplementedMessagingServiceServer) UploadPreKeyBundle(context.Context, *UploadPreKeyBundleRequest) (*UploadPreKeyBundleResponse, error) {
...
func _MessagingService_UploadPreKeyBundle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadPreKeyBundleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessagingServiceServer).UploadPreKeyBundle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessagingService_UploadPreKeyBundle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessagingServiceServer).UploadPreKeyBundle(ctx, req.(*UploadPreKeyBundleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MessagingService_GetPreKeyBundle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPreKeyBundleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessagingServiceServer).GetPreKeyBundle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessagingService_GetPreKeyBundle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessagingServiceServer).GetPreKeyBundle(ctx, req.(*GetPreKeyBundleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MessagingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MessagingService_UploadPreKeyBundle_Handler,
		},
		{
