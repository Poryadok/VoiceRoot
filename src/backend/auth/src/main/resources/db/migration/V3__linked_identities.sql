-- auth_db v3 — multi-profile/verification (docs/features/multi-profile.md): OAuth linked platform identities (see migrations/auth_db/000004_linked_identities.up.sql)
