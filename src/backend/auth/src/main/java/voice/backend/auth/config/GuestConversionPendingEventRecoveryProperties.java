...
/** Bounded, enabled-by-default recovery settings for durable PENDING_EVENT work. */
@Validated
@ConfigurationProperties(prefix = "auth.guest-conversion.pending-event")
public class GuestConversionPendingEventRecoveryProperties {
