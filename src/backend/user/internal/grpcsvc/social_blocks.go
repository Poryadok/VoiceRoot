...
// AccountBlockChecker reports whether two accounts must not see each other in discovery (blocks).
// Implemented by Social S2S (IsBlocked) when configured.
...
// SocialGRPCBlocks calls voice.social.v1 SocialService.IsBlocked in both directions.
