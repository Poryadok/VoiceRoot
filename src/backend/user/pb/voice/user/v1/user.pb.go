...
const file_voice_user_v1_user_proto_rawDesc = "" +
	...
	"profileIds\"A\n" +
	"\vProfileList\x122\n" +
	"\bprofiles\x18\x01 \x03(\v2\x16.voice.user.v1.ProfileR\bprofiles\"\xe5\x05\n" +
	"\aProfile\x12\x0e\n" +
	...
	"\tfrozen_at\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampH\x05R\bfrozenAt\x88\x01\x01B\r\n" +
	"\v_avatar_urlB\r\n" +
	"\v_banner_urlB\x06\n" +
	"\x04_bioB\x10\n" +
	"\x0e_custom_statusB\x15\n" +
	"\x13_verification_badgeB\f\n" +
	"\n" +
	"_frozen_at\"\xfc\x02\n" +
	...
	"\x13verification_status\x18\x01 \x01(\v2!.voice.user.v1.VerificationStatusR\x12verificationStatus\"\x89\x01\n" +
	"\x16SetVerificationRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\x12+\n" +
	"\x11verification_type\x18\x02 \x01(\tR\x10verificationType\x12\x19\n" +
	"\x05badge\x18\x03 \x01(\tH\x00R\x05badge\x88\x01\x01B\b\n" +
	"\x06_badge\"m\n" +
	"\x17SetVerificationResponse\x12R\n" +
	"\x13verification_status\x18\x01 \x01(\v2!.voice.user.v1.VerificationStatusR\x12verificationStatus\"9\n" +
	"\x18ClearVerificationRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\"o\n" +
	"\x19ClearVerificationResponse\x12R\n" +
	"\x13verification_status\x18\x01 \x01(\v2!.voice.user.v1.VerificationStatusR\x12verificationStatus\"]\n" +
	"$StartOrganizationVerificationRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\x12\x16\n" +
	"\x06domain\x18\x02 \x01(\tR\x06domain\"^\n" +
	"%StartOrganizationVerificationResponse\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domain\x12\x1d\n" +
	"\n" +
	"txt_record\x18\x02 \x01(\tR\ttxtRecord\"E\n" +
	"$CheckOrganizationVerificationRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\"{\n" +
	"%CheckOrganizationVerificationResponse\x12R\n" +
	"\x13verification_status\x18\x01 \x01(\v2!.voice.user.v1.VerificationStatusR\x12verificationStatus\"h\n" +
	...
	"\x10kept_profile_ids\x18\x01 \x03(\tR\x0ekeptProfileIds*\xc8\x01\n" +
	...
	"\x13PRIVACY_PRESET_WORK\x10\x032\xb8\x14\n" +
	"\vUserService\x12o\n" +
	...
	"\x15GetVerificationStatus\x12+.voice.user.v1.GetVerificationStatusRequest\x1a,.voice.user.v1.GetVerificationStatusResponse\x12`\n" +
	"\x0fSetVerification\x12%.voice.user.v1.SetVerificationRequest\x1a&.voice.user.v1.SetVerificationResponse\x12f\n" +
	"\x11ClearVerification\x12'.voice.user.v1.ClearVerificationRequest\x1a(.voice.user.v1.ClearVerificationResponse\x12\x8a\x01\n" +
	"\x1dStartOrganizationVerification\x123.voice.user.v1.StartOrganizationVerificationRequest\x1a4.voice.user.v1.StartOrganizationVerificationResponse\x12\x8a\x01\n" +
	"\x1dCheckOrganizationVerification\x123.voice.user.v1.CheckOrganizationVerificationRequest\x1a4.voice.user.v1.CheckOrganizationVerificationResponse\x12u\n" +
	"\x16ApplyDowngradeProfiles\x12,.voice.user.v1.ApplyDowngradeProfilesRequest\x1a-.voice.user.v1.ApplyDowngradeProfilesResponse\x12\x84\x01\n" +
