...
func (c *matchmakingServiceClient) RespondToMatch(ctx context.Context, in *RespondToMatchRequest, opts ...grpc.CallOption) (*RespondToMatchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMatchmakingServiceServer) GetSearchStatus(context.Context, *GetSearchStatusRequest) (*GetSearchStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSearchStatus not implemented")
}
...
func (UnimplementedMatchmakingServiceServer) RateMatch(context.Context, *RateMatchRequest) (*RateMatchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RateMatch not implemented")
}
func (UnimplementedMatchmakingServiceServer) GetPlayerRating(context.Context, *GetPlayerRatingRequest) (*GetPlayerRatingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPlayerRating not implemented")
}
func (UnimplementedMatchmakingServiceServer) BanFromMM(context.Context, *BanFromMMRequest) (*BanFromMMResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BanFromMM not implemented")
}
func (UnimplementedMatchmakingServiceServer) UnbanFromMM(context.Context, *UnbanFromMMRequest) (*UnbanFromMMResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnbanFromMM not implemented")
}
...
func (UnimplementedMatchmakingServiceServer) UpsertPlayerGameEntry(context.Context, *UpsertPlayerGameEntryRequest) (*UpsertPlayerGameEntryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpsertPlayerGameEntry not implemented")
}
...
func _MatchmakingService_RespondToMatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RespondToMatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchmakingServiceServer).RespondToMatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MatchmakingService_RespondToMatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchmakingServiceServer).RespondToMatch(ctx, req.(*RespondToMatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
