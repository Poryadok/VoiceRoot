...
func ensureAudienceAllowed(ctx context.Context, recipient, caller uuid.UUID, audience privacy.Audience, friends ProfileFriendChecker, space SpaceCoMembershipChecker) error {
