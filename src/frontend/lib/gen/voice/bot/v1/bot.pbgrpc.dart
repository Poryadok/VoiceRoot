...
class BotServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.GetBotBySlugResponse> getBotBySlug(
  ...
  static final _$getBotBySlug =
      $grpc.ClientMethod<$0.GetBotBySlugRequest, $0.GetBotBySlugResponse>(
          '/voice.bot.v1.BotService/GetBotBySlug',
          ($0.GetBotBySlugRequest value) => value.writeToBuffer(),
          $0.GetBotBySlugResponse.fromBuffer);
...
abstract class BotServiceBase extends $grpc.Service {
  ...
  BotServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.GetBotBySlugRequest, $0.GetBotBySlugResponse>(
            'GetBotBySlug',
            getBotBySlug_Pre,
            false,
            false,
            ...
            ($0.GetBotBySlugResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$0.GetBotBySlugResponse> getBotBySlug_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetBotBySlugRequest> $request) async {
    return getBotBySlug($call, await $request);
  }

  $async.Future<$0.GetBotBySlugResponse> getBotBySlug(
