...
import '../../common/v1/space_lifecycle.pb.dart' as $2;
...
class ApplySpaceLifecycleFenceRequest extends $pb.GeneratedMessage {
  factory ApplySpaceLifecycleFenceRequest({
    $2.SpaceLifecycleFenceRequest? fence,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'voice.notification.v1'),
      createEmptyInstance: create)
    ..aOM<$2.SpaceLifecycleFenceRequest>(1, _omitFieldNames ? '' : 'fence',
        subBuilder: $2.SpaceLifecycleFenceRequest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $2.SpaceLifecycleFenceRequest get fence => $_getN(0);
  @$pb.TagNumber(1)
  set fence($2.SpaceLifecycleFenceRequest value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasFence() => $_has(0);
  @$pb.TagNumber(1)
  void clearFence() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.SpaceLifecycleFenceRequest ensureFence() => $_ensure(0);
}
...
class ApplySpaceLifecycleFenceResponse extends $pb.GeneratedMessage {
  factory ApplySpaceLifecycleFenceResponse({
    $2.SpaceLifecycleFenceReceipt? receipt,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'voice.notification.v1'),
      createEmptyInstance: create)
    ..aOM<$2.SpaceLifecycleFenceReceipt>(1, _omitFieldNames ? '' : 'receipt',
        subBuilder: $2.SpaceLifecycleFenceReceipt.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $2.SpaceLifecycleFenceReceipt get receipt => $_getN(0);
  @$pb.TagNumber(1)
  set receipt($2.SpaceLifecycleFenceReceipt value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasReceipt() => $_has(0);
  @$pb.TagNumber(1)
  void clearReceipt() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.SpaceLifecycleFenceReceipt ensureReceipt() => $_ensure(0);
}
...
class PurgeSpaceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'voice.notification.v1'),
      createEmptyInstance: create)
    ..aOM<$2.SpacePurgeRequest>(1, _omitFieldNames ? '' : 'purge',
        subBuilder: $2.SpacePurgeRequest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $2.SpacePurgeRequest get purge => $_getN(0);
  @$pb.TagNumber(1)
  set purge($2.SpacePurgeRequest value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasPurge() => $_has(0);
  @$pb.TagNumber(1)
  void clearPurge() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.SpacePurgeRequest ensurePurge() => $_ensure(0);
}
...
class PurgeSpaceResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'voice.notification.v1'),
      createEmptyInstance: create)
    ..aOM<$2.SpacePurgeReceipt>(1, _omitFieldNames ? '' : 'receipt',
        subBuilder: $2.SpacePurgeReceipt.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $2.SpacePurgeReceipt get receipt => $_getN(0);
  @$pb.TagNumber(1)
  set receipt($2.SpacePurgeReceipt value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasReceipt() => $_has(0);
  @$pb.TagNumber(1)
  void clearReceipt() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.SpacePurgeReceipt ensureReceipt() => $_ensure(0);
}
