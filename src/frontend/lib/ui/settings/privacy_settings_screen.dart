...
class PrivacySettingsScreen extends ConsumerStatefulWidget {
  ...
  static const Key showReadReceiptsKey = Key('privacy_show_read_receipts');
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      key: PrivacySettingsScreen.showReadReceiptsKey,
                      title: Text(l10n.privacyShowReadReceipts),
                      value: settings.showReadReceipts,
                      onChanged: (v) => setState(
                        () =>
                            _settings = settings.copyWith(showReadReceipts: v),
                      ),
                    ),
                    if (_error != null) ...[
