...
final mobileOpenedChatStripProvider =
  ...
  (ref) => MobileOpenedChatStripController(),
);

class MobileOpenedChatStripController extends StateNotifier<List<String>> {
  MobileOpenedChatStripController() : super(const []);
  ...
  void openChat(String chatId) {
    ...
    state = next.length > kMobileOpenedChatStripLimit
        ? next.sublist(0, kMobileOpenedChatStripLimit)
        : next;
  }
