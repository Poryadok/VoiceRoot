...
void main() {
  ...
  testWidgets('pinned bar collapses to single line when multiple pins', (
    tester,
  ) async {
                ...
                'message_list': {
                  'messages': [
                    ...
                    },
                    {
                      ...
                      'chat': {'id': 'chat-abc'},
                      'sender_profile_id': 'profile-b',
                      'content': 'Second pin preview should not show',
                      'is_pinned': true,
                      'reactions_json': '[]',
                      'mentions_json': '[]',
                      'attachments_json': '[]',
    ...
    expect(find.textContaining('pinned messages'), findsOneWidget);
    expect(find.text('Second pin preview should not show'), findsNothing);
