...
proof_require 'msg.Nak()' 'negative acknowledgement of first delivery'
proof_require 'nc.Flush()' 'flushed negative acknowledgement before receiver exits'
...
proof_require 'http: 8222' 'hub monitoring endpoint for subscriber readiness'
proof_require '/subsz?subs=1' 'server-confirmed bootstrap subscriber readiness'
proof_require 'subscriptions_list' 'bootstrap subscription evidence from hub'
proof_require '$JS.API.CONSUMER.CREATE.chat_events.proof_chat_noack' 'isolated no-ACK consumer create subject'
