...
| Тип                                  | Wire / enum              | Есть |
|--------------------------------------|--------------------------|------|
| Новое сообщение в DM / чате          | `new_message`            | ✓    |
...
См. [text-chat.md](text-chat.md) § Send options; producer — Messaging `message.sent`; consumer — Notification Service. Service detail — [notification-service.md](../microservices/notification-service.md) § `send_silent`.
