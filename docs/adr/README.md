...
Lightweight ADRs for cross-cutting infra and security decisions. Status: **accepted** unless noted.

| ADR | Title |
|-----|-------|
| [001](001-compose-postgres-redis-versions.md) | Compose / k8s Postgres 16 and Redis 7 parity |
