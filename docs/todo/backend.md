...
- [ ] **[Messaging] Durable delivery consumer** — Messaging consumer updates durable cursor for list ✓✓ (R4-03-H06); Realtime JetStream `message.delivery_ack` publisher **shipped** (Batch 11) — pairs with `last_message_delivery_state` bullet above.
