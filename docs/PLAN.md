...
| [Спейсы](features/spaces.md) | core-live | Create/join/tree/invites, gRPC audit read и durable ownership store/freeze/terminal foundation работают; target public transfer/scheduled-delete и полная Gateway/Flutter lifecycle/audit-вертикаль, catalog/templates, audit filters/writers и entry requirements остаются открыты. |
