...
- **Grace period**: 7 дней после неудачного платежа; уведомления на 1-й, 3-й и 7-й день; после — откат к бесплатным лимитам
- **Downgrade-сценарий (личная подписка)**: лишние профили замораживаются, не удаляются; активными остаются 2 последних использованных; заморозка = нельзя войти, данные сохраняются; при возврате подписки — разморозка
